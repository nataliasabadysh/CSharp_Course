...
<table align="center">
    <tbody>
        <tr>
            <td>
                <h3 align="center"></h3>
                <h3>.NET(C#) -> compiler - > CIL -> CLR -> JIT -> Native code  </h3>
                <br>
                <p>* CLR - Common Runtime Language  ( Virtual Machine component +  .NET Framework = .NET )  </p>
                <p>* CIL - Common Intermediate Language ( Microsoft Intermediate Language (MSIL) ) </p>
                <p>* JIT - Just-In-Time - (compiler translates the MSIL code of an assembly to native code) </p>
            </td>
        </tr>
    <tbody>
</table>
...
## 🚀 Data Type C#
<p>  Variable Declaration & Initialization  + Data Type <p>

```
bool isTrue = true;     //  false 
byte name = 10;         //  from 0 to 255 (1 byte)                                      System.Byte
sbyte name = -100;      //  -128 to 127  (1 byte)                                       System.Byte 
short name = 2;         //  -32768 to 32767 (2 byte)                                    System.Int16 
ushort name = 2;        //  0 to 65535 (2 byte)                                         System.Int16
int  name = 1;          //  -2147483648 to 2147483647 (4 byte)                          System.Int32
uint name = 1;          //  0 to 4294967295 (4 byte)                                    System.UInt32
long name = 1000000;    //  –9223372036854775808 to 9223372036854775807(8 byte).        System.Int64
ulong name = 100;       //  0 to 18 446 744 073 709 551 615  (8 byte).                  System.Int64
float name = 1.1;       //  ±1.5*10−45 to ±3.4*1038  (4 byte)                           System.Single

var f = 1.0f;           //  var +  literal number of float

double name = 1. 111;   //  ±5.0*10−324 to ±1.7*10308 (8 byte).                         System.Double

var d  = 1.0d;          //  var +  literal number of double

char name = 'A';        //  Unicode (2 byte)                                            System.Char
string name = 'Hey';    //  Unicode,                                                    System.String
object name =           //  (4 byte)                                                    System.Object

int a = 4;   
* System.Int32 b = 4;
                                                     
```
<p> To check the size of Var "sizeof(dataType)" <p>
<b> Variable is always defined with a data type.</b>

```
var box = 123;  // or int number = 123 
Console.WriteLine(sizeof(Int32)); // 4 
```

```
var box = 123.5;   // or double number = 123.3
...
```
int a = 123;  //   a = 123      4 bytes 
double b = a; //   a = 123  and 8 bytes 
```

<p>Example. Convert an double variable to int  "Convert.ToInt32(a)" ||  " (int)(a)" </p>
...
```
Creted new class (Library.cs)
```
 class Library
    {
      public  static void Pause()
        {
            Console.ReadLine('this is code inside of method Pause()');
        }
    }
```
 ...
 public static void Main(string[] args)
    {
        ...
        Console.WriteLine("Name" + fName + "Age:" + age + "getting paid" + salary );  
        ...
        string interpolation = String.Format($"Name: {fName}, Age: {age}, Salary: {salary}");
...
<p> ***  we can use as Convert.ToInt32 or int.Parse()   </p>
...
```
    for (int i = 0; i < 9; i++) {  Console.WriteLine(" num2 {0} = {1}", i, i * i); }
    for (int i = 100; i < 10; i++) {  Console.WriteLine(i);  }
```
...
static void M(int n) {
        ...
        {
            int h = 10;
            Console.Write($"Main   = {h}"); // 10   (value - from the Stack )
            M(h); // h = 10
            Console.Write($"Main   = {h}"); // 10   (value - from the Stack )
        }
```
...
```
<p> CONSTRUCTOR (Method as a Type) </p>
...
```
    ...
    class Program
    {
        static void Main(string[] args)
        {
            Complex z1 = new Complex(10, 29);   -  Exemplar Structure
    ...
    -- to call method we need add + static 
    ...
    Complex z3 = Complex.Sum(z1, z2); -  Exemplar Structure  ( instead   Complex z3 = z1.Sum(z1, z2); )
```

<p>Example without static </p>
...
```
- instead of Sum we can say operator 
- and the we can call 
...
<p>Example ( class VS struct )</p>

    ```struct  (storing in Steack )
...
<h3>Example with THIS and Constructor 🤓</h3> 
...
static void Main(string[] args)
    {
        Worker worker = new Worker("Andriy", 21, 200); //  -> Examplar class 
    }
```
Random Numbers 
...
```
    ...
    // Examplar Class 
            ...
            Worker.AGE = 123; // ❌ Error -> const is readonly 
            Worker.t = 34;     // static ✅
```
...
-  * without Constructor 
    ...
    class Herro{   public int Level;  }
    class Program
    {
        static void Maine(string[] args) {
            Herro herro = new Herro(); // var
            herro.Level = 1;
        }
    }
...
- *  with constuctor
    ...
    class Program2
    {
        static void Maine(string[] args)
        {
            Herro herro = new Herro(1);   <- var herro 
        }
    }

---  to get results by ref 
 ...
 class Herro
    ...
    class Program2
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(herro.GetLevel()); // 1
        }
    }
----- if we need to chenge the value  
...
static void Main(string[] args)
        ...
        private static int MyTryParse(string s)
        {
            ...
            finally{ Console.WriteLine("выполнено");  }
        }
```


<h1>Arrays  - it's data type </h1>
- lesson 4
- class 



<p> Create 1000 varables with loop 😝 </p>
...
<b> Create 1000 varables  With Array !🤓</b>
...
<p>✅ variables </p>
        ...
        int? z = null; //  Nullable<int> n 
        // int? z  = address?.city?.street?.house?.N;
...
<h3> switch/case </h3>
                ...
                switch (selection)
                {
                  case "Y": Console.WriteLine("clicked was on Y");  break;
                  case "N": Console.WriteLine("clicked was on N");  break;
                  default:  Console.WriteLine(" no clicks ");  break;
                }
...
<h3>  Nullable<int> n = address?.city?.street?.house?.N; </h3>


                int n = address?.city?.street?.house?.N ?? -2;   // or int? n = address?.city?.street?.house?.N;
...
<p>Example</p>
...

            {
...

                {
                    ...
                    public void StopBIOS() { 
                        Console.WriteLine("Stop BIOS ... ");
                    }
                    public void StopOS() { 
                        Console.WriteLine(" Stop OS ... "); 
                    }

                    public void SayBey() { 
                        Console.WriteLine(" Say Bey ... ");
                    }
...

            {
                public class Program
                {
                    static void Maine (string[] args)
                    {
                        Robot robot = new Robot( Name: "Nata_1", Level: 1 );
                        ...
                        Robot robot2 = new Robot(Name: "Nata_1", Level: 1);
                        Robot robot3 = new Robot(Name: "Nata_1", Level: 1);
                        Robot robot4 = new Robot(Name: "Nata_1", Level: 1);
...
// we can  add state and Reg.Exp.
            ...
            public class Robot

                {
                    ...
                    public Robot(string Name, int Level)
                    {
                        ...
                        {
                            this.Name = $"Default Name { Robot.DefaultIndex++}";  
                        }
                        else {
                            this.Name = Name;
                            Robot.nameCol.Add(Name); //  save in current value 
            ...
            using System;
            namespace GreekbrainsCourse.Lesson1
            {
...

            {
...

                {
                    ...
                    private string SetName( string value){ return this.name;}
                    public void Rename (string NewName) { this.name = NewName; }  // + login password  if Admin 
                    private Robot2(string Name, int Level)
                    {

                        if ( (Name == String.Empty || char.IsDigit(Name[0])) || Robot2.nameCol.IndexOf(Name) != -1)
                        { this.name = $"Default Name { Robot2.DefaultIndex++}"; }
                        else { this.name = Name; Robot2.nameCol.Add(Name); }
                
                        this.level = Level;
                        this.setState = State.PowerOff;

                    }
                    public Robot2(string Name): this(Name, 1) 
                {
                        this.level = 123;
                    }
                    public Robot2() : this(String.Empty, 1) 
                    {
                        this.level = 124;
                    }
                    ...
                    public void StartOS(){ Console.WriteLine("Start BIOS ... "); }
                    public void SayHi(){ Console.WriteLine("Say Hi ... ");}
                    public void StopBIOS(){ Console.WriteLine("Stop BIOS ... ");}
                    public void StopOS() { Console.WriteLine(" Stop OS ... ");}
                    public void SayBey(){Console.WriteLine(" Say Bey ... ");}
                }
            }
...
# intterface
        ...
        interface IAttack  { void Attack(HeroBase hero); }


        class HeroAgillity: HeroBase, IAttack
            {
                public void Attack(HeroBase hero)  { hero.GetDamage(HeroStrength.r.Next(10, 20)); }
            }
...
<p> Example 2 Sort collectrion +  : IComparable </p>
...
* foreach  + IEnumerable  - pattern iterator ( has move next by index )
        ...
        class Department
            {
                ...
                public Department(params Worker[] Args)
                {
                    ...
                    foreach (var e in Args) { list.Add(e); }
                }
...
*  try {} 
*  catch (Exception e)  when + code of Error 
*  finally {}
        ...
        try { MyClass.A(); }
            ...
            when (e.Error == 313  ) { Console.WriteLine(e.Message);  }
