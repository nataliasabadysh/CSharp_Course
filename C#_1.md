...
<h3>Types C# </h3>
        ...
        long name = 1000000; //  –9 223 372 036 854 775 808 to 9 223 372 036 854 775 807 (8 byte). System.Int64
...
namespace GreekbrainsCourse.Lesson1
{
    ...
    {
        // class  Robot  has state
        public int Level { get; set;  }
        public string Name { get; set; }


        // Constructor,  this - ref to the Class (init class)
...
namespace GreekbrainsCourse.Lesson1
{
    public class Program
    {
        static void Maine (string[] args)
         {
            // create exemplar calss Robot -> Robot robot = new Robot 
...
// we can  add state and Reg.Exp.
 ...
 public class Robot

    {
        ...
        public Robot(string Name, int Level)
        {
            // if first is Name === String.Empty
            // if first is number -> char.IsDigit(Name[0])
            // if Name was already declared -> Robot.nameCol.IndexOf(Name) != -1
...
namespace GreekbrainsCourse.Lesson1
{
...

    {
        ...
        // Constructor,  this - ref to the Class
